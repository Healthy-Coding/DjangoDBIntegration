...
class Collegeboard(models.Model):
    ...
    race_ethnicity_unknown = models.DecimalField(db_column='Race_Ethnicity_Unknown', max_digits=3, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
